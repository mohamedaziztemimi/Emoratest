...
const STATS = [
  { label: "Detect 8 Emotions", value: "Real-Time", delta: "From mouse patterns" },
  { label: "80%+ Accuracy", value: "XGBoost ML", delta: "Proven classifier" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-10 lg:gap-16 items-center w-full">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <p style={{ fontSize: "18px", color: "#4B5563", maxWidth: "480px", lineHeight: 1.7, margin: 0, marginBottom: 0 }}>
              EmoraTest detects 5 behavioral states from mouse behavior — frustrated, confused, hesitating, engaged, and disengaged. Find your conversion killer in hours, not weeks.
            </p>
